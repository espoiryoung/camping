...
const LogIn=()=>{
    ...
    //http://13.209.27.220:8080/article?sortType=LATEST%28%EC%B5%9C%EC%8B%A0%EC%88%9C%29
    ...
    return(
        <SafeAreaView style={{flex:1, backgroundColor:"#FFF3E9" }}>
            ...
            <View style={{backgroundColor:'#FDA758', marginHorizontal:20,borderRadius:8 , alignItems:'center'}}>
                <Text>회원가입하기</Text>
            </View>
